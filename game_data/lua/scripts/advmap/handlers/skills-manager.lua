...
for hero,_ in HEROES do
    ...
    --     [SKILLBONUS_GET_STRONGER] = 0,
    --     [SKILLBONUS_GET_WISER] = 0,
    --     [SKILLBONUS_ONSLAUGHT] = 0,
    --     [SKILLBONUS_LAST_STAND] = 0,
    --     [SKILLBONUS_GEAR_UP] = 0,
    --     [SKILLBONUS_HEROES_LEGACY] = 0,
    --     [SKILLBONUS_MYTHOLOGY] = 0,
