...
STARTING_ARMIES = {
    ...
    [H_MINASLI] = { {CREATURE_GREMLIN,38}, {CREATURE_STONE_GARGOYLE,13}, {CREATURE_ARCANE_EAGLE,1} },
    -- fortress
    ...
    [H_GORSHAK] = { {CREATURE_SHAMAN,13}, {CREATURE_ORC_WARRIOR,9}, {CREATURE_ORCCHIEF_BUTCHER,1} }, -- +1 slayer
    [H_KARUKAT] = { {CREATURE_GOBLIN,40}, {CREATURE_SHAMAN,10}, {CREATURE_WYVERN,1} },
    [H_KUJIN] = { {CREATURE_GOBLIN,35}, {CREATURE_SHAMAN_WITCH,10}, {CREATURE_SHAMAN_WITCH,10} },
}
