...
ARTIFACT_WAND_OF_SPELL = 3                          -- grants random spell
...
ARTIFACT_WAR_DRUMS = 17                             -- creatures have +1 dmg
ARTIFACT_EVERCOLD_ICICLE = 18                       -- ice spells damage
...
ARTIFACT_DRAGON_SCALE_ARMOR = 36                    -- large creatures have +5% initiative
ARTIFACT_DRAGON_SCALE_SHIELD = 37                   -- small creatures have +5% initiative
ARTIFACT_DRAGON_BONE_GRAVES = 38                    -- non-flying creatures have +10% initiative
ARTIFACT_DRAGON_WING_MANTLE = 39                    -- flying creatures have +10% initiative
...
ARTIFACT_TOME_OF_LIGHT = 77                         -- hero learns all light spells
ARTIFACT_TOME_OF_DARKNESS = 78                      -- hero learns all dark spells
ARTIFACT_TOME_OF_NATURE = 79                        -- hero learns all natural spells
...
ARTIFACT_MASK_OF_EQUITY = 89                        -- equalize hero level to enemy hero
ARTIFACT_EDGE_OF_BALANCE = 90                       -- swap att/def for evil factions
ARTIFACT_RING_OF_MACHINE_AFFINITY = 91              -- improve war machines
ARTIFACT_HORN_OF_PLENTY = 92                        -- random resource per day
ARTIFACT_RING_OF_BANISHMENT = 93                    -- reduce enemy natural spells and hero learns banish
...
ARTIFACT_ORB_OF_FIRE = 194                          -- fire spells damage
ARTIFACT_ORB_OF_WATER = 195                         -- ice spells damage
...
ARTIFACT_210 = 210                                  -- todo 210
ARTIFACT_211 = 211                                  -- todo 211
ARTIFACT_212 = 212                                  -- todo 212
ARTIFACT_213 = 213                                  -- todo 213
ARTIFACT_214 = 214                                  -- todo 214
ARTIFACT_215 = 215                                  -- todo 215
ARTIFACT_216 = 216                                  -- todo 216
ARTIFACT_217 = 217                                  -- todo 217
ARTIFACT_218 = 218                                  -- todo 218
ARTIFACT_219 = 219                                  -- todo 219
ARTIFACT_220 = 220                                  -- todo 220
ARTIFACT_221 = 221                                  -- todo 221
ARTIFACT_222 = 222                                  -- todo 222
ARTIFACT_223 = 223                                  -- todo 223
ARTIFACT_224 = 224                                  -- todo 224
ARTIFACT_225 = 225                                  -- todo 225
ARTIFACT_226 = 226                                  -- todo 226
ARTIFACT_227 = 227                                  -- todo 227
ARTIFACT_228 = 228                                  -- todo 228
ARTIFACT_229 = 229                                  -- todo 229
ARTIFACT_230 = 230                                  -- vanilla set enlightenment
ARTIFACT_231 = 231                                  -- vanilla set enlightenment
ARTIFACT_232 = 232                                  -- vanilla set hunter
ARTIFACT_233 = 233                                  -- vanilla set hunter
ARTIFACT_234 = 234                                  -- vanilla set ogre
ARTIFACT_235 = 235                                  -- vanilla set ogre
ARTIFACT_236 = 236                                  -- vanilla set runic-war
ARTIFACT_237 = 237                                  -- vanilla set runic-war
ARTIFACT_238 = 238                                  -- vanilla set demonic
ARTIFACT_239 = 239                                  -- vanilla set demonic
ARTIFACT_240 = 240                                  -- vanilla set dwarven
ARTIFACT_241 = 241                                  -- vanilla set dwarven
ARTIFACT_242 = 242                                  -- vanilla set dwarven
ARTIFACT_243 = 243                                  -- vanilla set dwarven
ARTIFACT_244 = 244                                  -- vanilla set lion
ARTIFACT_245 = 245                                  -- vanilla set lion
ARTIFACT_246 = 246                                  -- vanilla set lion
ARTIFACT_247 = 247                                  -- vanilla set sar-issus
ARTIFACT_248 = 248                                  -- vanilla set sar-issus
ARTIFACT_249 = 249                                  -- vanilla set sar-issus
ARTIFACT_250 = 250                                  -- vanilla set sar-issus
ARTIFACT_251 = 251                                  -- vanilla set necro
ARTIFACT_252 = 252                                  -- vanilla set necro
ARTIFACT_253 = 253                                  -- vanilla set necro
ARTIFACT_254 = 254                                  -- vanilla set necro


ARTIFACT_CLASS_OTHER = 0
ARTIFACT_CLASS_MINOR = 1
ARTIFACT_CLASS_MAJOR = 2
ARTIFACT_CLASS_RELIC = 3
...
ARTIFACTS_DATA = {
    [ARTIFACT_SWORD_OF_MIGHT]                = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_RIGHTHAND, special=0},
    [ARTIFACT_AXE_OF_THE_MOUNTAIN_LORDS]     = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_RIGHTHAND, special=0},
    [ARTIFACT_WAND_OF_SPELL]                 = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_RIGHTHAND, special=0},
    [ARTIFACT_UNICORN_HORN_BOW]              = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_RIGHTHAND, special=1},
    [ARTIFACT_TITANS_TRIDENT]                = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_RIGHTHAND, special=0},
    [ARTIFACT_STAFF_OF_THE_NETHERWORLD]      = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_RIGHTHAND, special=0},
    [ARTIFACT_SHACKLES_OF_THE_LAST_MAN]      = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_POCKET, special=0},
    [ARTIFACT_FOUR_LEAF_CLOVER]              = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_POCKET, special=0},
    ...
    [ARTIFACT_CROWN_OF_COURAGE]              = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_HEAD, special=0},
    [ARTIFACT_ALL_SEEING_CROWN]              = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_HEAD, special=1},
    [ARTIFACT_SENTINELS_BREASTPLATE]         = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_BODY, special=0},
    [ARTIFACT_BREASTPLATE_OF_ELDRICHT_MIGHT] = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_BODY, special=0},
    [ARTIFACT_PEDANT_OF_MASTERY]             = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_NECK, special=1},
    [ARTIFACT_NECKLACE_OF_THE_EAGLE]         = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_NECK, special=0},
    [ARTIFACT_WAR_DRUMS]                     = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_LEFTHAND, special=0},
    [ARTIFACT_EVERCOLD_ICICLE]               = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_NECK, special=0},
    [ARTIFACT_NECKLACE_OF_VICTORY]           = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_NECK, special=0},
    [ARTIFACT_MAGNETIC_RING]                 = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_RING, special=0},
    [ARTIFACT_WAR_BANNER]                    = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_RIGHTHAND, special=0},
    [ARTIFACT_RING_OF_HASTE]                 = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_RIGHTHAND, special=1},
    [ARTIFACT_RING_OF_THE_BROKEN_WILL]       = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_RING, special=0},
    [ARTIFACT_BOOTS_OF_THE_SWIFT_JOUNREY]    = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_LEGS, special=0},
    [ARTIFACT_GOLDEN_HORSESHOE]              = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_POCKET, special=0},
    [ARTIFACT_BOOTS_OF_THE_OPEN_ROAD]        = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_LEGS, special=0},
    [ARTIFACT_BOOTS_OF_INTERFERENCE]         = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_LEGS, special=0},
    [ARTIFACT_ENDLESS_SACK_OF_GOLD]          = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_SHOULDERS, special=0},
    [ARTIFACT_ENDLESS_POUCH_OF_GOLD]         = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_POCKET, special=0},
    [ARTIFACT_ANGEL_WINGS]                   = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_SHOULDERS, special=1},
    [ARTIFACT_CAPE_OF_KINGS]                 = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_SHOULDERS, special=0},
    [ARTIFACT_PHOENIX_FEATHER_CAPE]          = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_SHOULDERS, special=0},
    [ARTIFACT_CLOAK_OF_DEATHS_SHADOW]        = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_SHOULDERS, special=0},
    [ARTIFACT_TURBAN_OF_ENLIGHTMENT]         = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_HEAD, special=0},
    [ARTIFACT_SCALE_MAIL_OF_ENLIGHTMENT]     = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_BODY, special=0},
    [ARTIFACT_DRAGON_SCALE_ARMOR]            = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_BODY, special=0},
    [ARTIFACT_DRAGON_SCALE_SHIELD]           = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_LEFTHAND, special=0},
    [ARTIFACT_DRAGON_BONE_GRAVES]            = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_LEGS, special=0},
    [ARTIFACT_DRAGON_WING_MANTLE]            = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_SHOULDERS, special=0},
    [ARTIFACT_DRAGON_TEETH_NECKLACE]         = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_NECK, special=0},
    [ARTIFACT_DRAGON_TALON_CROWN]            = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_HEAD, special=0},
    [ARTIFACT_DRAGON_EYE_RING]               = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_RING, special=0},
    [ARTIFACT_DRAGON_FLAME_TONGUE]           = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_RIGHTHAND, special=0},
    [ARTIFACT_ROBE_OF_THE_MAGISTER]          = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_BODY, special=0},
    [ARTIFACT_STAFF_OF_THE_MAGISTER]         = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_RIGHTHAND, special=0},
    [ARTIFACT_CROWN_OF_THE_MAGISTER]         = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_HEAD, special=0},
    [ARTIFACT_RING_OF_THE_MAGISTER]          = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_RING, special=0},
    ...
    [ARTIFACT_HELM_OF_THE_DWARVEN_KINGS]     = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_HEAD, special=0},
    [ARTIFACT_MAGIC_SCROLL_OF_SPELL]         = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_LEFTHAND, special=1},
    [ARTIFACT_GRAAL]                         = { class=ARTIFACT_CLASS_OTHER, slot=ARTIFACT_LOCATION_BACKPACK, special=1},
    [ARTIFACT_BOOTS_OF_LEVITATION]           = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_LEGS, special=1},
    [ARTIFACT_HELM_OF_THE_LICH]              = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_HEAD, special=0},
    [ARTIFACT_ARMOR_OF_VALOR]                = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_BODY, special=0},
    [ARTIFACT_BOOTS_OF_SWIFTNESS]            = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_LEGS, special=0},
    [ARTIFACT_MOONBLADE]                     = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_LEFTHAND, special=0},
    [ARTIFACT_WAR_HORN]                      = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_POCKET, special=0},
    ...
    [ARTIFACT_PENDANT_OF_CONFLUX]            = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_NECK, special=0},
    [ARTIFACT_SANDALS_OF_THE_BLESSED]        = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_LEGS, special=0},
    [ARTIFACT_SANDROS_CLOAK]                 = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_SHOULDERS, special=1},
    ...
    [ARTIFACT_RING_OF_THE_SHADOWBRAND]       = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_RING, special=0},
    [ARTIFACT_CUIRASS_OF_THE_DWARVEN_KINGS]  = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_BODY, special=0},
    [ARTIFACT_GREAVES_OF_THE_DWARVEN_KINGS]  = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_LEGS, special=0},
    [ARTIFACT_TOME_OF_DESTRUCTION]           = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_LEFTHAND, special=0},
    [ARTIFACT_TOME_OF_LIGHT]                 = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_LEFTHAND, special=0},
    [ARTIFACT_TOME_OF_DARKNESS]              = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_LEFTHAND, special=0},
    [ARTIFACT_TOME_OF_NATURE]                = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_LEFTHAND, special=0},
    [ARTIFACT_BEGINNER_MAGIC_STICK]          = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_RIGHTHAND, special=0},
    [ARTIFACT_RUNIC_WAR_AXE]                 = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_RIGHTHAND, special=0},
    [ARTIFACT_RUNIC_WAR_HARNESS]             = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_BODY, special=0},
    [ARTIFACT_SKULL_OF_THE_FORBIDDEN]        = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_POCKET, special=0},
    ...
    [ARTIFACT_CROWN_OF_LEADER]               = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_HEAD, special=0},
    [ARTIFACT_MASK_OF_EQUITY]                = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_HEAD, special=1},
    [ARTIFACT_EDGE_OF_BALANCE]               = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_RIGHTHAND, special=0},
    [ARTIFACT_RING_OF_MACHINE_AFFINITY]      = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_RING, special=1},
    ...
    [ARTIFACT_SACRED_SEED]                   = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_POCKET, special=0},
    ...
    [ARTIFACT_CROWN_OF_THE_FROST_LORD]       = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_HEAD, special=0},
    ...
    [ARTIFACT_RING_OF_CELERITY]              = { class=ARTIFACT_CLASS_OTHER, slot=ARTIFACT_LOCATION_RING, special=1},
    ...
    [ARTIFACT_GENJIS_HAT]                    = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_HEAD, special=0},
    [ARTIFACT_GENJIS_VEST]                   = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_BODY, special=0},
    [ARTIFACT_GENJIS_SANDALS]                = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_LEGS, special=0},
    [ARTIFACT_GENJIS_SILKSWORD]              = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_RIGHTHAND, special=0},
    [ARTIFACT_SENTINELS_HELM]                = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_HEAD, special=0},
    [ARTIFACT_SENTINELS_BOOTS]               = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_LEGS, special=0},
    [ARTIFACT_SENTINELS_SHIELD]              = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_LEFTHAND, special=0},
    [ARTIFACT_OBSIDIAN_ARMOR]                = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_BODY, special=0},
    [ARTIFACT_ELRATHS_DIVINE_SHIELD]         = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_LEFTHAND, special=0},
    [ARTIFACT_ROD_OF_TORMENT]                = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_RIGHTHAND, special=0},
    [ARTIFACT_CODEX_OF_THE_SAINT]            = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_LEFTHAND, special=0},
    [ARTIFACT_VIZIRS_CAP]                    = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_HEAD, special=0},
    [ARTIFACT_PLUNDERED_VEST]                = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_BODY, special=0},
    ...
    [ARTIFACT_CELESTIAL_JUSTICAR_SHIELD]     = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_LEFTHAND, special=0},
    ...
    [ARTIFACT_POTION_OF_STAMINA]             = { class=ARTIFACT_CLASS_OTHER, slot=ARTIFACT_LOCATION_POCKET, special=1},
    [ARTIFACT_POTION_OF_EXPERIENCE]          = { class=ARTIFACT_CLASS_OTHER, slot=ARTIFACT_LOCATION_POCKET, special=1},
    [ARTIFACT_SYLVAN_AMULET]                 = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_NECK, special=0},
    [ARTIFACT_SHADOW_MASK]                   = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_HEAD, special=0},
    ...
    [ARTIFACT_SENTINELS_BLADE]               = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_RIGHTHAND, special=0},
    ...
    [ARTIFACT_SHADOW_BLADE]                  = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_RIGHTHAND, special=0},
    [ARTIFACT_SHADOWSTEP_SHOES]              = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_LEGS, special=0},
    [ARTIFACT_RANGERS_CUIRASS]               = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_BODY, special=0},
    [ARTIFACT_MAGISTERS_SANDALS]             = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_LEGS, special=0},
    [ARTIFACT_LEGENDARY_BOOTS]               = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_LEGS, special=0},
    [ARTIFACT_COLLAR_OF_PRIMAL_RAGE]         = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_NECK, special=0},
    ...
    [ARTIFACT_DEATH_KNIGHT_BOOTS]            = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_LEGS, special=0},
    ...
    [ARTIFACT_CLOAK_OF_DARKNESS]             = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_SHOULDERS, special=0},
    [ARTIFACT_SHANTIRI_BREASTPLATE]          = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_BODY, special=1},
    ...
    [ARTIFACT_CELESTIAL_JUSTICAR_HELMET]     = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_HEAD, special=0},
    [ARTIFACT_RING_OF_STRENGTH]              = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_RING, special=0},
    [ARTIFACT_SPEAR_OF_THE_FROST_LORD]       = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_RIGHTHAND, special=0},
    [ARTIFACT_STAFF_OF_THE_LYRE]             = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_RIGHTHAND, special=0},
    [ARTIFACT_SANCTUARYS_CROWN]              = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_HEAD, special=0},
    ...
    [ARTIFACT_SPIRIT_OF_OPPRESSION]          = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_NECK, special=0},
    [ARTIFACT_CRIMSON_SCYTHE]                = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_RIGHTHAND, special=0},
    ...
    [ARTIFACT_WILL_OF_URGASH]                = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_RIGHTHAND, special=0},
    [ARTIFACT_MOONLIGHT_BAND]                = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_RING, special=0},
    [ARTIFACT_BLOOD_CRYSTAL]                 = { class=ARTIFACT_CLASS_OTHER, slot=ARTIFACT_LOCATION_BACKPACK, special=1},
    [ARTIFACT_RANGERS_CAPE]                  = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_SHOULDERS, special=0},
    [ARTIFACT_MOON_CHARM]                    = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_NECK, special=0},
    [ARTIFACT_FORGOTTEN_RING]                = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_RING, special=0},
    [ARTIFACT_FROZEN_HEART]                  = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_POCKET, special=0},
    [ARTIFACT_MOONLIGHT_COAT]                = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_SHOULDERS, special=0},
    ...
    [ARTIFACT_WRAPS_OF_THE_OWL]              = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_SHOULDERS, special=0},
    [ARTIFACT_CELESTIAL_JUSTICAR_ARMOR]      = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_BODY, special=0},
    [ARTIFACT_VIKING_HATCHET]                = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_RIGHTHAND, special=0},
    [ARTIFACT_ORB_OF_AIR]                    = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_POCKET, special=0},
    [ARTIFACT_ORB_OF_EARTH]                  = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_POCKET, special=0},
    [ARTIFACT_ORB_OF_FIRE]                   = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_POCKET, special=0},
    [ARTIFACT_ORB_OF_WATER]                  = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_POCKET, special=0},
    [ARTIFACT_OGRE_CLUB]                     = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_RIGHTHAND, special=0},
    [ARTIFACT_OGRE_SHIELD]                   = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_LEFTHAND, special=0},
    [ARTIFACT_SHIELD_OF_THE_DWARVEN_KINGS]   = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_LOCATION_LEFTHAND, special=0},
    [ARTIFACT_199]                           = { class=ARTIFACT_CLASS_OTHER, slot=ARTIFACT_LOCATION_BACKPACK, special=1},
}
...
ARTFSET_NONE = 0
ARTFSET_HAVEN_4PC = 1           -- +2 to all primary stats
ARTFSET_HAVEN_4PCX = 2          -- archangels/seraphs cast their spell at start of combat
ARTFSET_HAVEN_6PC = 3           -- summons a row of footmen in front of hero's army at start of combat
ARTFSET_HAVEN_6PCX = 4          -- summons a row of squires in front of hero's army at start of combat
...
ARTIFACT_SETS = {
    ...
    [ARTIFACT_SET_VIZIR] = {ARTIFACT_CURSED_DICES, ARTIFACT_REGAL_ARMOUR, ARTIFACT_VIZIRS_CAP, ARTIFACT_VIZIRS_SCIMITAR, ARTIFACT_PALACE_SHOES},
