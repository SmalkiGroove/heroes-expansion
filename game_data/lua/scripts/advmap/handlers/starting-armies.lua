...
function SetStartingArmy(hero)
    ...
    local merge = PLAYER_ARMY_BONUS[player] or IsDuelMode()
    for i = 1,7 do
        if army[i] then
            local creature = army[i][1]
            local nb = round(army[i][2] * DIFFICULTY_MULTIPLIER[player])
            AddHeroCreatures(hero, creature, nb, merge and -1 or i-1)
        end
    end
    sleep(1)
...
STARTING_ARMIES = {
    ...
    [H_GABRIELLE] = { {CREATURE_GRIFFIN,10} },
    -- preserve
    ...
    [H_DIRAEL] = { {CREATURE_BLADE_JUGGLER,45}, {CREATURE_PIXIE,35} },
    [H_TIERU] = { {CREATURE_BLADE_JUGGLER,38}, {CREATURE_PIXIE,22}, {CREATURE_DRUID,8} },
    [H_YLTHIN] = { {CREATURE_PIXIE,22}, {CREATURE_WOOD_ELF,14}, {CREATURE_UNICORN,2} },
    -- academy
    ...
    [H_CYRUS] = { {CREATURE_GREMLIN,51}, {CREATURE_IRON_GOLEM,20}, {CREATURE_MAGI,7} },
    ...
    [H_HANGVUL] = { {CREATURE_BROWLER,29}, {CREATURE_THANE,1} },
    [H_ERLING] = { {CREATURE_DEFENDER,48}, {CREATURE_BROWLER,19}, {CREATURE_RUNE_MAGE,2} },
    -- necropolis
    ...
    [H_LUCRETIA] = { {CREATURE_WALKING_DEAD,39}, {CREATURE_MANES,19}, {CREATURE_VAMPIRE,4} },
    ...
    [H_BIARA] = { {CREATURE_FAMILIAR,66}, {CREATURE_DEMON,36}, {CREATURE_SUCCUBUS,8} },
    ...
    [H_SHADYA] = { {CREATURE_WITCH,38}, {CREATURE_MATRON,2} },
    ...
    [H_GARUNA] = { {CREATURE_GOBLIN,69}, {CREATURE_ORC_WARRIOR,21}, {CREATURE_CENTAUR,4} },
    [H_GORSHAK] = { {CREATURE_SHAMAN,38}, {CREATURE_ORC_WARRIOR,23}, {CREATURE_ORCCHIEF_BUTCHER,2} },
    [H_KARUKAT] = { {CREATURE_GOBLIN,69}, {CREATURE_SHAMAN,33}, {CREATURE_WYVERN,1} },
    [H_KUJIN] = { {CREATURE_GOBLIN,55}, {CREATURE_SHAMAN,23}, {CREATURE_SHAMAN,23} },
}
