...
-- Slots
ARTIFACT_SLOT_BACKPACK = 0
ARTIFACT_SLOT_BODY = 1
ARTIFACT_SLOT_HEAD = 2
ARTIFACT_SLOT_RIGHTHAND = 3
ARTIFACT_SLOT_LEFTHAND = 4
ARTIFACT_SLOT_LEGS = 5
ARTIFACT_SLOT_SHOULDERS = 6
ARTIFACT_SLOT_RING = 7
ARTIFACT_SLOT_NECK = 8
ARTIFACT_SLOT_POCKET = 9
...
ARTIFACT_PENDANT_OF_MASTERY = 15                    -- pendant of mastery
...
ARTIFACT_DRAGON_BONE_GRAVES = 38                    -- non-flying creatures have +5% initiative
ARTIFACT_DRAGON_WING_MANTLE = 39                    -- flying creatures have +5% initiative
...
ARTIFACT_PHOENIX_FEATHER_CAPE = 85                  -- reduce enemy fire spells and immune to frost power
...
ARTIFACT_ALTAR_OF_ELEMENTS_SHARD = 102	            -- increase elemental spell damages
...
ARTIFACT_CENTAUR_CROSSBOW = 153                     -- increase hero attacks damage
...
ARTIFACT_DRAGONSBANE = 187                          -- damage ignore defense and cancel luck
ARTIFACT_CUIRASS_OF_THE_STAG = 188                  -- /
ARTIFACT_WRAPS_OF_THE_OWL = 189                     -- /
ARTIFACT_CELESTIAL_JUSTICAR_ARMOR = 190             -- reduce melee damage
...
ARTIFACT_OGRE_CLUB = 196                            -- reduce enemy defense
ARTIFACT_OGRE_SHIELD = 197                          -- reduce enemy attack
ARTIFACT_SHIELD_OF_THE_DWARVEN_KINGS = 198          -- reduce ranged damage
ARTIFACT_199 = 199                                  -- creatures have -1 speed
ARTIFACT_BLOOD_CRYSTAL = 200                        -- yrwanna spec **
...
ARTIFACT_POTION_OF_ENLIGHTENMENT = 204              -- gain experience and mana **
ARTIFACT_POTION_OF_POWER = 205                      -- gain spellpower **
ARTIFACT_POTION_OF_STAMINA = 206                    -- gain movement points **
ARTIFACT_POTION_OF_VISION = 207                     -- reveal area and enemies **
ARTIFACT_POTION_OF_TELEPORTATION = 208              -- teleport until end of turn **
ARTIFACT_POTION_OF_SKILL = 209                      -- upgrade a known skill **
ARTIFACT_210 = 210                                  -- unused
ARTIFACT_211 = 211                                  -- unused
ARTIFACT_212 = 212                                  -- unused
ARTIFACT_213 = 213                                  -- unused
ARTIFACT_214 = 214                                  -- unused
ARTIFACT_215 = 215                                  -- unused
ARTIFACT_216 = 216                                  -- unused
ARTIFACT_217 = 217                                  -- unused
ARTIFACT_218 = 218                                  -- unused
ARTIFACT_219 = 219                                  -- unused
ARTIFACT_FILLER_POCKET = 220                        -- pocket slot filler
ARTIFACT_221 = 221                                  -- placeholder set 25
ARTIFACT_222 = 222                                  -- placeholder set 25
ARTIFACT_223 = 223                                  -- placeholder set 26
ARTIFACT_224 = 224                                  -- placeholder set 26
ARTIFACT_225 = 225                                  -- placeholder set 27
ARTIFACT_226 = 226                                  -- placeholder set 27
ARTIFACT_227 = 227                                  -- placeholder set 28
ARTIFACT_228 = 228                                  -- placeholder set 28
ARTIFACT_229 = 229                                  -- placeholder set 29
ARTIFACT_230 = 230                                  -- placeholder set 29
ARTIFACT_231 = 231                                  -- placeholder set 30
ARTIFACT_232 = 232                                  -- placeholder set 30
ARTIFACT_233 = 233                                  -- vanilla set draconic
ARTIFACT_234 = 234                                  -- vanilla set draconic
ARTIFACT_235 = 235                                  -- vanilla set draconic
ARTIFACT_236 = 236                                  -- vanilla set draconic
ARTIFACT_237 = 237                                  -- vanilla set enlightenment
ARTIFACT_238 = 238                                  -- vanilla set enlightenment
ARTIFACT_239 = 239                                  -- vanilla set hunter
ARTIFACT_240 = 240                                  -- vanilla set hunter
ARTIFACT_241 = 241                                  -- vanilla set ogre
ARTIFACT_242 = 242                                  -- vanilla set ogre
ARTIFACT_243 = 243                                  -- vanilla set runic-war
ARTIFACT_244 = 244                                  -- vanilla set runic-war
ARTIFACT_245 = 245                                  -- vanilla set demonic
ARTIFACT_246 = 246                                  -- vanilla set demonic
ARTIFACT_247 = 247                                  -- vanilla set dwarven
ARTIFACT_248 = 248                                  -- vanilla set dwarven
ARTIFACT_249 = 249                                  -- vanilla set lion
ARTIFACT_250 = 250                                  -- vanilla set lion
ARTIFACT_251 = 251                                  -- vanilla set sar-issus
ARTIFACT_252 = 252                                  -- vanilla set sar-issus
...
ARTIFACT_SET_NONE = 0
ARTIFACT_SET_1 = 11
ARTIFACT_SET_HAVEN = 11
ARTIFACT_SET_SYLVAN = 12
ARTIFACT_SET_INFERNO = 13
ARTIFACT_SET_NECRO = 14
ARTIFACT_SET_ACADEMY = 15
ARTIFACT_SET_DUNGEON = 16
ARTIFACT_SET_DWARVEN = 17
ARTIFACT_SET_ORCS = 18
ARTIFACT_SET_DRAGON = 19
ARTIFACT_SET_ENLIGHTEN = 20
ARTIFACT_SET_FROST = 21
ARTIFACT_SET_GENJI = 22
ARTIFACT_SET_ELDENA = 23
ARTIFACT_SET_WAR = 24
ARTIFACT_SET_VIZIR = 25
ARTIFACT_SET_SPIRIT = 26
ARTIFACT_SET_WARMAGE = 27
ARTIFACT_SET_BANDIT = 28
ARTIFACT_SET_BESTIAL = 29
ARTIFACT_SET_SAINT = 30
ARTIFACT_SET_ARCHANGEL = 31
ARTIFACT_SET_WANDERER = 32
ARTIFACT_SET_SAILOR = 33
ARTIFACT_SET_MOON = 34
ARTIFACT_SET_COUNT = 34
...
ARTFSET_HAVEN_6PC = 3           -- creatures always get good morale
ARTFSET_HAVEN_6PCX = 4          -- ^ creatures gain att/def per morale
ARTFSET_SYLVAN_4PC = 5          -- gain spellpower for nature spells
ARTFSET_SYLVAN_4PCX = 6         -- ^ creatures deal bonus damage to favored enemies
ARTFSET_SYLVAN_6PC = 7          -- creatures always get lucky hits
ARTFSET_SYLVAN_6PCX = 8         -- ^ creatures gain spell-proof per luck
ARTFSET_ACADEMY_4PC = 9         -- casters in hero's army have double mana and spellpower
...
ARTFSET_NECRO_6PCX = 20         -- ^ undeads have regeneration
ARTFSET_INFERNO_4PC = 21        -- creatures attacks leave flames on the ground
ARTFSET_INFERNO_4PCX = 22       -- ^ remove enemy fire-proof
ARTFSET_INFERNO_6PC = 23        -- reduce enemy units luck
...
ARTFSET_WARMAGE_5PC = 43        -- gain +1 spellpower and knowledge, and +1 to all primary stats per magic school at expert level on level up
ARTFSET_BANDIT_5PC = 44         -- creatures get +1 speed and ?
...
ARTFSET_ARCHANGEL_5PC = 48      -- +10 to all stats and unlock angel wings
...
ARTIFACTS_DATA = {
    ...
    [ARTIFACT_FOUR_LEAF_CLOVER]              = { class=ARTIFACT_CLASS_MAJOR, slot=ARTIFACT_SLOT_POCKET, set=ARTIFACT_SET_NONE, special=0},
    [ARTIFACT_SHIELD_OF_CRYSTAL_ICE]         = { class=ARTIFACT_CLASS_RELIC, slot=ARTIFACT_SLOT_LEFTHAND, set=ARTIFACT_SET_NONE, special=0},
    [ARTIFACT_OCEAN_CHARM]                   = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_SLOT_NECK, set=ARTIFACT_SET_SAILOR, special=1},
    [ARTIFACT_CROWN_OF_COURAGE]              = { class=ARTIFACT_CLASS_RELIC, slot=ARTIFACT_SLOT_HEAD, set=ARTIFACT_SET_NONE, special=0},
    [ARTIFACT_ALL_SEEING_CROWN]              = { class=ARTIFACT_CLASS_RELIC, slot=ARTIFACT_SLOT_HEAD, set=ARTIFACT_SET_NONE, special=1},
    [ARTIFACT_SENTINELS_BREASTPLATE]         = { class=ARTIFACT_CLASS_RELIC, slot=ARTIFACT_SLOT_BODY, set=ARTIFACT_SET_HAVEN, special=0},
    [ARTIFACT_BREASTPLATE_OF_ELDRICHT_MIGHT] = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_SLOT_BODY, set=ARTIFACT_SET_NONE, special=0},
    [ARTIFACT_PENDANT_OF_MASTERY]            = { class=ARTIFACT_CLASS_RELIC, slot=ARTIFACT_SLOT_NECK, set=ARTIFACT_SET_NONE, special=1},
    [ARTIFACT_NECKLACE_OF_THE_EAGLE]         = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_SLOT_NECK, set=ARTIFACT_SET_BESTIAL, special=0},
    [ARTIFACT_WAR_DRUMS]                     = { class=ARTIFACT_CLASS_MAJOR, slot=ARTIFACT_SLOT_LEFTHAND, set=ARTIFACT_SET_WAR, special=0},
    [ARTIFACT_EVERCOLD_ICICLE]               = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_SLOT_NECK, set=ARTIFACT_SET_FROST, special=0},
    [ARTIFACT_NECKLACE_OF_VICTORY]           = { class=ARTIFACT_CLASS_MAJOR, slot=ARTIFACT_SLOT_NECK, set=ARTIFACT_SET_WAR, special=0},
    [ARTIFACT_MAGNETIC_RING]                 = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_SLOT_RING, set=ARTIFACT_SET_NONE, special=0},
    ...
    [ARTIFACT_ENDLESS_SACK_OF_GOLD]          = { class=ARTIFACT_CLASS_MAJOR, slot=ARTIFACT_SLOT_SHOULDERS, set=ARTIFACT_SET_NONE, special=0},
    ...
    [ARTIFACT_DRAGON_SCALE_ARMOR]            = { class=ARTIFACT_CLASS_MAJOR, slot=ARTIFACT_SLOT_BODY, set=ARTIFACT_SET_DRAGON, special=0},
    [ARTIFACT_DRAGON_SCALE_SHIELD]           = { class=ARTIFACT_CLASS_MAJOR, slot=ARTIFACT_SLOT_LEFTHAND, set=ARTIFACT_SET_DRAGON, special=0},
    [ARTIFACT_DRAGON_BONE_GRAVES]            = { class=ARTIFACT_CLASS_MAJOR, slot=ARTIFACT_SLOT_LEGS, set=ARTIFACT_SET_DRAGON, special=0},
    [ARTIFACT_DRAGON_WING_MANTLE]            = { class=ARTIFACT_CLASS_MAJOR, slot=ARTIFACT_SLOT_SHOULDERS, set=ARTIFACT_SET_DRAGON, special=0},
    ...
    [ARTIFACT_BOOTS_OF_LEVITATION]           = { class=ARTIFACT_CLASS_MAJOR, slot=ARTIFACT_SLOT_LEGS, set=ARTIFACT_SET_NONE, special=1},
    [ARTIFACT_HELM_OF_THE_LICH]              = { class=ARTIFACT_CLASS_MAJOR, slot=ARTIFACT_SLOT_HEAD, set=ARTIFACT_SET_NECRO, special=0},
    [ARTIFACT_ARMOR_OF_VALOR]                = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_SLOT_BODY, set=ARTIFACT_SET_NONE, special=0},
    [ARTIFACT_BOOTS_OF_SWIFTNESS]            = { class=ARTIFACT_CLASS_RELIC, slot=ARTIFACT_SLOT_LEGS, set=ARTIFACT_SET_NONE, special=0},
    [ARTIFACT_MOONBLADE]                     = { class=ARTIFACT_CLASS_RELIC, slot=ARTIFACT_SLOT_LEFTHAND, set=ARTIFACT_SET_MOON, special=0},
    [ARTIFACT_WAR_HORN]                      = { class=ARTIFACT_CLASS_MAJOR, slot=ARTIFACT_SLOT_POCKET, set=ARTIFACT_SET_WAR, special=0},
    [ARTIFACT_BAND_OF_CONJURER]              = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_SLOT_RING, set=ARTIFACT_SET_NONE, special=0},
    [ARTIFACT_EMERALD_SLIPPERS]              = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_SLOT_LEGS, set=ARTIFACT_SET_NONE, special=0},
    [ARTIFACT_CLOAK_OF_SYLANNA]              = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_SLOT_SHOULDERS, set=ARTIFACT_SET_NONE, special=0},
    [ARTIFACT_CURSED_RING]                   = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_SLOT_RING, set=ARTIFACT_SET_SPIRIT, special=0},
    [ARTIFACT_TUNIC_OF_CARVED_FLESH]         = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_SLOT_BODY, set=ARTIFACT_SET_SPIRIT, special=0},
    [ARTIFACT_RING_OF_CAUTION]               = { class=ARTIFACT_CLASS_MAJOR, slot=ARTIFACT_SLOT_RING, set=ARTIFACT_SET_NONE, special=0},
    [ARTIFACT_HELM_OF_CHAOS]                 = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_SLOT_HEAD, set=ARTIFACT_SET_INFERNO, special=0},
    [ARTIFACT_PENDANT_OF_CONFLUX]            = { class=ARTIFACT_CLASS_MAJOR, slot=ARTIFACT_SLOT_NECK, set=ARTIFACT_SET_WARMAGE, special=0},
    [ARTIFACT_SANDALS_OF_THE_BLESSED]        = { class=ARTIFACT_CLASS_MAJOR, slot=ARTIFACT_SLOT_LEGS, set=ARTIFACT_SET_SAINT, special=0},
    [ARTIFACT_SANDROS_CLOAK]                 = { class=ARTIFACT_CLASS_RELIC, slot=ARTIFACT_SLOT_SHOULDERS, set=ARTIFACT_SET_NONE, special=1},
    [ARTIFACT_RING_OF_THE_UNREPENTANT]       = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_SLOT_RING, set=ARTIFACT_SET_NECRO, special=0},
    [ARTIFACT_AMULET_OF_NECROMANCY]          = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_SLOT_NECK, set=ARTIFACT_SET_NECRO, special=0},
    [ARTIFACT_FREIDA]                        = { class=ARTIFACT_CLASS_OTHER, slot=ARTIFACT_SLOT_BACKPACK, set=ARTIFACT_SET_NONE, special=1},
    [ARTIFACT_RING_OF_THE_SHADOWBRAND]       = { class=ARTIFACT_CLASS_MAJOR, slot=ARTIFACT_SLOT_RING, set=ARTIFACT_SET_INFERNO, special=0},
    [ARTIFACT_CUIRASS_OF_THE_DWARVEN_KINGS]  = { class=ARTIFACT_CLASS_MAJOR, slot=ARTIFACT_SLOT_BODY, set=ARTIFACT_SET_DWARVEN, special=0},
    [ARTIFACT_GREAVES_OF_THE_DWARVEN_KINGS]  = { class=ARTIFACT_CLASS_MAJOR, slot=ARTIFACT_SLOT_LEGS, set=ARTIFACT_SET_DWARVEN, special=0},
    [ARTIFACT_TOME_OF_DESTRUCTION]           = { class=ARTIFACT_CLASS_RELIC, slot=ARTIFACT_SLOT_LEFTHAND, set=ARTIFACT_SET_NONE, special=0},
    [ARTIFACT_TOME_OF_LIGHT]                 = { class=ARTIFACT_CLASS_RELIC, slot=ARTIFACT_SLOT_LEFTHAND, set=ARTIFACT_SET_NONE, special=0},
    [ARTIFACT_TOME_OF_DARKNESS]              = { class=ARTIFACT_CLASS_RELIC, slot=ARTIFACT_SLOT_LEFTHAND, set=ARTIFACT_SET_NONE, special=0},
    [ARTIFACT_TOME_OF_NATURE]                = { class=ARTIFACT_CLASS_RELIC, slot=ARTIFACT_SLOT_LEFTHAND, set=ARTIFACT_SET_NONE, special=0},
    [ARTIFACT_BEGINNER_MAGIC_STICK]          = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_SLOT_RIGHTHAND, set=ARTIFACT_SET_NONE, special=0},
    [ARTIFACT_RUNIC_WAR_AXE]                 = { class=ARTIFACT_CLASS_MAJOR, slot=ARTIFACT_SLOT_RIGHTHAND, set=ARTIFACT_SET_WARMAGE, special=0},
    ...
    [ARTIFACT_MASK_OF_EQUITY]                = { class=ARTIFACT_CLASS_RELIC, slot=ARTIFACT_SLOT_HEAD, set=ARTIFACT_SET_NONE, special=1},
    [ARTIFACT_EDGE_OF_BALANCE]               = { class=ARTIFACT_CLASS_MAJOR, slot=ARTIFACT_SLOT_RIGHTHAND, set=ARTIFACT_SET_NONE, special=0},
    [ARTIFACT_RING_OF_MACHINE_AFFINITY]      = { class=ARTIFACT_CLASS_RELIC, slot=ARTIFACT_SLOT_RING, set=ARTIFACT_SET_NONE, special=1},
    [ARTIFACT_HORN_OF_PLENTY]                = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_SLOT_POCKET, set=ARTIFACT_SET_NONE, special=0},
    [ARTIFACT_RING_OF_BANISHMENT]            = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_SLOT_RING, set=ARTIFACT_SET_DUNGEON, special=0},
    ...
    [ARTIFACT_CENTAUR_CROSSBOW]              = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_SLOT_RIGHTHAND, set=ARTIFACT_SET_NONE, special=0},
    ...
    [ARTIFACT_ELRATHS_UNITY]                 = { class=ARTIFACT_CLASS_RELIC, slot=ARTIFACT_SLOT_POCKET, set=ARTIFACT_SET_ARCHANGEL, special=0},
    ...
    [ARTIFACT_CELESTIAL_JUSTICAR_ARMOR]      = { class=ARTIFACT_CLASS_RELIC, slot=ARTIFACT_SLOT_BODY, set=ARTIFACT_SET_ARCHANGEL, special=0},
    [ARTIFACT_VIKING_HATCHET]                = { class=ARTIFACT_CLASS_MINOR, slot=ARTIFACT_SLOT_RIGHTHAND, set=ARTIFACT_SET_BANDIT, special=0},
    [ARTIFACT_ORB_OF_AIR]                    = { class=ARTIFACT_CLASS_MAJOR, slot=ARTIFACT_SLOT_POCKET, set=ARTIFACT_SET_NONE, special=0},
...
for artefact,data in ARTIFACTS_DATA do
    if ARTIFACT_SETS[data.set] then
        insert(ARTIFACT_SETS[data.set], artefact)
    else
        ARTIFACT_SETS[data.set] = {artefact}
    end
end
