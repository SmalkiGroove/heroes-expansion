...
• Starts with innate skill Master of Blessings.
...
• Hero starts with skills Blood Rage and Voice instead of Runelore. He cannot learn spells but starts with Ralling Cry, learns tier 2 warcries at level 10 and tier 3 warcries at level 20.
...
• After combat, the hero fixes 1 destroyed Golem in exchange for 1 Gargoyle.
...
• Summon Elementals and Conjure Phoenix spells are cast with 1 bonus Spellpower for every 3 levels of the hero.
...
• All hero’s attacks deal +5% damage for every level of the hero.
• When a friendly creature dies in combat, the hero gets an ATB boost.
...
• Every creature in hero's army explodes at the start of their turn in combat, dealing fire damage to surrounding enemies.
...
• The hero always casts Fireball for 3 mana at a random enemy when his turn comes in combat. Before level 20, the ATB of the hero is set to half after casting (hero cannot be controlled). After level 20, the hero can be controlled after casting but he loses the ATB reset.
...
• Starts with innate skill Master of Mind.
