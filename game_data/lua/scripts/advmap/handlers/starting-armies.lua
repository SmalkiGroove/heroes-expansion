...
STARTING_ARMIES = {
    ...
    [H_GABRIELLE] = { {CREATURE_GRIFFIN,5} }, -- +1 griffin
    -- preserve
    ...
    [H_YLTHIN] = { {CREATURE_PIXIE,12}, {CREATURE_WOOD_ELF,5} }, -- +1 unicorn
    -- academy
    ...
    [H_CYRUS] = { {CREATURE_GREMLIN,34}, {CREATURE_IRON_GOLEM,8}, {CREATURE_MAGI,1} }, -- +1 mage
    ...
    [H_ERLING] = { {CREATURE_DEFENDER,34}, {CREATURE_BROWLER,8} }, -- +1 rune priest
    -- necropolis
    ...
    [H_LUCRETIA] = { {CREATURE_WALKING_DEAD,16}, {CREATURE_MANES,8}, {CREATURE_VAMPIRE,1} }, -- +1 vampire
    ...
    [H_BIARA] = { {CREATURE_FAMILIAR,38}, {CREATURE_DEMON,18}, {CREATURE_SUCCUBUS,1} }, -- +1 succubus
    [H_ORLANDO] = { {CREATURE_DEMON,22}, {CREATURE_HELL_HOUND,10} },
    -- dungeon
    ...
    [H_GARUNA] = { {CREATURE_GOBLIN,38}, {CREATURE_ORC_WARRIOR,8}, {CREATURE_CENTAUR,2} }, -- +1 centaur
    [H_GORSHAK] = { {CREATURE_SHAMAN,13}, {CREATURE_ORC_WARRIOR,9} }, -- +1 slayer
