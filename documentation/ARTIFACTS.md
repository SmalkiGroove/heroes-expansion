...
+2 Spellpower
+1 Morale
Hero troops are Unstoppable (immunity to Slow) and are able to walk above obstacles like flying creatures.
- __Sylvan Amulet__ :
+2 Spellpower
+2 Knowledge
+1 Luck
...
+3 Attack
+5% Initiative to friendly walking melee creatures
- __Dragon Wing Mantle__ :
+3 Knowledge
+5% Initiative to friendly flying creatures
- __Dragon Teeth Necklace__ :
+3 Spellpower
+5% Initiative to friendly casting creatures
- __Dragon Talon Crown__ :
+3 Knowledge
+1 Initiative to friendly war machines
- __Dragon Eye Ring__ :
+3 Spellpower
+5% Initiative to friendly shooting creatures
...
+4 Luck
- __Endless Sack of Gold__ :
Generates 1000 Golds per day.
- __Endless Purse of Gold__ :
...
+1 Attack
+1 Defense
Troops ignore 10% of target's defense per tile moved while attacking
