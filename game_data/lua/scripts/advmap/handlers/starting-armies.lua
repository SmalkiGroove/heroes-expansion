...
STARTING_ARMIES = {
    ...
    [H_GABRIELLE] = { {CREATURE_BATTLE_GRIFFIN,5} },
    -- preserve
    ...
    [H_BIARA] = { {CREATURE_FAMILIAR,38}, {CREATURE_DEMON,18}, {CREATURE_SUCCUBUS,2} },
    [H_ORLANDO] = { {CREATURE_DEMON,22}, {CREATURE_HELL_HOUND,10}, {CREATURE_DEVIL,99} },
    -- dungeon
