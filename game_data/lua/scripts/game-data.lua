...
HEROES = {
    ...
    [H_KASPAR] = NECROPOLIS,
    [H_VLADIMIR] = NECROPOLIS,
    [H_ORSON] = NECROPOLIS,
    [H_ORNELLA2] = NECROPOLIS,
    [H_LUCRETIA] = NECROPOLIS,
    [H_XERXON] = NECROPOLIS,
    [H_DEIRDRE] = NECROPOLIS,
    [H_NAADIR] = NECROPOLIS,
    [H_AISLINN] = NECROPOLIS,
    [H_GIOVANNI] = NECROPOLIS,
    [H_ARCHILUS] = NECROPOLIS,
    [H_ZOLTAN] = NECROPOLIS,
    [H_RAVEN] = NECROPOLIS,
    [H_ARANTIR] = NECROPOLIS,
    [H_THANT] = NECROPOLIS,
    [H_SANDRO] = NECROPOLIS,
    [H_VIDOMINA] = NECROPOLIS,
    [H_NIMBUS] = NECROPOLIS,
    ...
    [H_RAELAG] = DUNGEON,
    [H_YLAYA] = DUNGEON,
    [H_SEPHINROTH] = DUNGEON,
    [H_KASTORE] = DUNGEON,
    [H_YRBETH] = DUNGEON,
    
    [H_TELSEK] = STRONGHOLD,
    [H_GORSHAK] = STRONGHOLD,
    [H_GOTAI] = STRONGHOLD,
    [H_AZAR] = STRONGHOLD,
    [H_MATEWA] = STRONGHOLD,
    [H_KUNYAK] = STRONGHOLD,
    [H_KRAGH] = STRONGHOLD,
    [H_KILGHAN] = STRONGHOLD,
    [H_CRAGHACK] = STRONGHOLD,
    [H_KRAAL] = STRONGHOLD,
    [H_SHAKKARUKAT] = STRONGHOLD,
    [H_KUJIN] = STRONGHOLD,
    [H_SHIVA] = STRONGHOLD,
    [H_HAGGASH] = STRONGHOLD,
    [H_MUKHA] = STRONGHOLD,
    [H_URGHAT] = STRONGHOLD,
    [H_GARUNA] = STRONGHOLD,
    [H_ZOULEIKA] = STRONGHOLD,
    [H_ERIKA] = STRONGHOLD,
    [H_QUROQ] = STRONGHOLD,
}
